...
const StockChart = ({ info }) => {
    ...
    return (
        <>
            <div className=" overflow-hidden w-full flex-col m-auto md:flex md:w-full lg:w-[60vw] lg:flex-row lg:h-[60vh] lg:m-auto">
            
            {/* the below div is the one container */}
                <div className="flex  md:w-1/2 p-10 bg-gray-100 text-gray-600 items-center">
                ...
                {/* the below component is the Line chart  */}

                <div className="flex w-full md:w-1/2 px-5 pb-4 pt-8 bg-blue-500 text-white items-center">
